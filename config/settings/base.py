...
)  # (navoica_enroll/config/settings/base.py - 3 = navoica_enroll/)
...
SOCIALACCOUNT_PROVIDERS = {
    'edx': {
        'EDX_URL': NAVOICA_URL,
        'AUTH_PARAMS': {'token_type': 'jwt'},
    }
}

LOCAL_APPS = [
    "navoica_enroll.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "navoica_enroll.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "navoica_enroll.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "navoica_enroll.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "navoica_enroll.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
